...
export default class Slide {
    ...
    constructor(container: Element, slides: Array<Element>, controls: Element, time: number = 5000) {
    ...
    show(index: number) {
        ...
        if(this.thumbItems) {
            ...
            this.thumbItems.forEach((elemento) => {
                elemento.classList.remove('active');
            });
            this.thumb.classList.add('active');
        };

        this.slides.forEach(( elemento ) => this.hide(elemento));
